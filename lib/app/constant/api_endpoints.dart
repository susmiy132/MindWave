...
//   static const String getAllMeditations = '$baseUrl/meditations';
//   static const String createMeditation = '$baseUrl/meditations';
//   static const String deleteMeditation = '$baseUrl/meditations';

//     // 📝 Journal Endpoints
//   static const String getAllJournals = "${baseUrl}journal";
//   static const String createJournal = "${baseUrl}journal";
//   static const String deleteJournal = "${baseUrl}journal"; // Append /{id}
//   static const String updateJournal = "${baseUrl}journal"; // Append /{id}
